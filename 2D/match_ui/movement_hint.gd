...
func _on_confirm_button_pressed() -> void:
	...
	if Level.current_level.allow_inputs:
		Level.current_level.active_unit.movement_machine.current_state.transition('Sneak', { "path": Level.current_level.movement_system.path })
...
func _on_cancel_button_pressed() -> void:
	if Level.current_level.allow_inputs:
		Level.current_level.movement_system.wipe_planned_path()
		Level.current_level.movement_system.activate(Level.current_level.active_unit)
